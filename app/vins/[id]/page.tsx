    ...
    <main className="max-w-4xl mx-auto py-12 px-6">
      <div className="flex flex-col md:flex-row gap-10">
        <div className="w-full md:w-1/2">
          ...
          <Image
            src={`/vins/${vin.id}.png`} // à ajuster selon ton système de stockage
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-700 text-lg mt-2">
              Prix conseillé : <span className="font-bold text-rose-600">{vin.prix} €</span>
            </p>
          </div>
          ...
          <div className="mt-8">
            ...
            {vin.stocks.length === 0 ? (
              <p className="text-gray-500 italic">Aucun caviste ne propose actuellement ce vin.</p>
            ) : (
              <ul className="space-y-2">
                {vin.stocks.map((stock) => (
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-600">{stock.caviste.adresse}</p>
                    <p className="text-sm text-gray-800 mt-1">
                      Quantité : <span className="font-medium">{stock.quantite}</span>
                    </p>
                  </li>
                ))}
              </ul>
