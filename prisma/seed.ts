...
const VINS = [
  { nom: "Château Margaux", domaine: "Margaux", année: 2018, prix: 320.0, couleur: "rouge", imageFile: "1.png" },
  { nom: "Bourgogne Aligoté", domaine: "Domaine de la Soufrandière", année: 2021, prix: 18.5, couleur: "blanc", imageFile: "2.png" },
  { nom: "Côtes du Rhône", domaine: "E. Guigal", année: 2020, prix: 12.0, couleur: "rouge", imageFile: "3.png" },
  { nom: "Chablis Grand Cru", domaine: "Domaine William Fèvre", année: 2022, prix: 58.0, couleur: "blanc", imageFile: "4.png" },
  { nom: "Crozes-Hermitage", domaine: "Alain Graillot", année: 2020, prix: 28.5, couleur: "rouge", imageFile: "5.png" },
  { nom: "Tavel Rosé", domaine: "Château d'Aqueria", année: 2023, prix: 16.0, couleur: "rose", imageFile: "60.png" },
] as const
...
const CAVISTES = [
  {
    ...
    stocks: [
      ...
      { vin: { nom: "Bourgogne Aligoté", domaine: "Domaine de la Soufrandière", année: 2021 }, quantite: 12 },
      { vin: { nom: "Chablis Grand Cru", domaine: "Domaine William Fèvre", année: 2022 }, quantite: 6 },
    ],
  },
  {
    ...
    stocks: [
      ...
      { vin: { nom: "Bourgogne Aligoté", domaine: "Domaine de la Soufrandière", année: 2021 }, quantite: 5 },
  ...
  for (const c of CAVISTES) {
    ...
    for (const s of c.stocks) {
      ...
      let vin = await prisma.vin.findUnique({
        where: { vin_unique: { nom: s.vin.nom, domaine: s.vin.domaine, année: s.vin.année } } as any,
        select: { id: true },
      })
